        ...
        <div class="no-footer">
          ...
          <stencil-router>
            <stencil-route-switch>
              ...
              <stencil-route url={['/contact-form-error', '/contact-form-error/']} component="contact-form-error" exact={true}></stencil-route>
              <stencil-route url={['/contact-form-submited', '/contact-form-submited/']} component="contact-form-submited" exact={true}></stencil-route>
