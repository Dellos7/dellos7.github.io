...
const RrssNavbar = class {
    ...
    render() {
        return (h("div", { class: "rrss-navbar" }, h("ul", { class: "rrss-navbar-list not-animated" }, h("li", { class: "rrss-navbar-list-elem rrss-navbar-list-elem__github" }, h("a", { href: "https://github.com/" + this.githubUser, target: "_blank", rel: "noopener noreferrer" }, h("ion-icon", { name: "logo-github" }))), h("li", { class: "rrss-navbar-list-elem rrss-navbar-list-elem__twitter" }, h("a", { href: "https://twitter.com/" + this.twitterUser, target: "_blank", rel: "noopener noreferrer" }, h("ion-icon", { name: "logo-twitter" }))), h("li", { class: "rrss-navbar-list-elem rrss-navbar-list-elem__codepen" }, h("a", { href: "https://codepen.io/" + this.codepenUser, target: "_blank", rel: "noopener noreferrer" }, h("ion-icon", { name: "logo-codepen" }))), h("li", { class: "rrss-navbar-list-elem rrss-navbar-list-elem__linkedin" }, h("a", { href: "https://www.linkedin.com/in/" + this.linkedinUser, target: "_blank", rel: "noopener noreferrer" }, h("ion-icon", { name: "logo-linkedin" }))))));
    }
