...
const AboutPage = class {
    ...
    render() {
        return (h("div", null, h(Helmet, null, h("title", null, "Sobre m\u00ED ", seoConfig.pageTitleSuffix)), h("header", null, h("user-name", { content: "Sobre m\u00ED", showDomain: true })), h("p", { style: { textAlign: 'center' } }, "\uD83D\uDD28")));
    }
};
